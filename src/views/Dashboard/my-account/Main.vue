                        ...
                        <div class="bg-white p-5 shadow-steps">
                            ...
                            <template v-if="storeUser.userData?.type == 2">
                                ...
                                <div class="border shadow-lg rounded-lg  mt-4 border-[#cfcfcf] ">
                                    <div class="bg-blue-dark flex p-3 rounded-t-lg justify-center items-center">
                                        ...
                                        <p class="text-white">Top 3 Highest Bid</p>
                                    </div>
                                    <div class="flex justify-between gap-3  p-4 items-center"
                                        ...
                                        <div class="flex flex-col ">
                                            <p class="font-medium">{{ item?.vehicleDetails?.make }} {{
                                                item?.vehicleDetails?.model }}</p>
                                            <p class="text-[#4D4D4D] ">Beat 20 bidders</p>
                                        </div>
                                        <div>
                                            <p class="font-medium text-2xl">$35,800</p>
                                        </div>
