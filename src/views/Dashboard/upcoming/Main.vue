        ...
        <div v-else class="flex justify-between mt-5 gap-4">
                    ...
                    <div class="mt-4 flex flex-col gap-4">
                        ...
                        <div class="w-full flex flex-col gap-2">
                            ...
                            <div class="grid grid-cols-3  place-items-start gap-4">
                                ...
                                <label class="label-colors !p-2 !h-[40px] whitespace-pre w-full">
                                    <input type="radio" class="input-radio  on-silver" value="silver" name="color-redio">
                                    Silver
                                </label>
                                <label class="label-colors !p-2 !h-[40px] whitespace-pre w-full">
                                ...
                                <label class="label-colors !p-2 !h-[40px] whitespace-pre w-full">
                                    <input type="radio" class="input-radio  on-yellow" value="yellow" name="color-redio">
                                    Yellow
                                </label>
                                <label class="label-colors !p-2 !h-[40px] whitespace-pre w-full">
                        ...
                        <div class="w-full">
                            ...
                            <div class="flex justify-between items-center gap-6 ">
                                <input class="p-2 w-full mt-3 uppercase  border border-[#E0E0E0] text-[#858585] rounded-lg"
            ...
            <div class="w-[70%]">
                ...
                <div
                    ...
                    <div v-for="(aution, index) in data" :key="index" class="bg-white flex hover:shadow-lg cursor-pointer duration-200 transition-all ease-in  mb-7 gap-5 items-start shadow-steps  w-full "
                        ...
                        <div class="w-full flex   p-5 sm:p-0 relative" :class="changeLayouts ? 'flex-col' : ''">
                            <swiper pagination :modules="modules" :slides-per-view="1" class="swiper-autions"
                                ...
                                <swiper-slide v-for="(photos, indexPhoto) in aution.vehicleDetails.exteriorPhotos" :key="indexPhoto">
                                    <!--  <p class="font-semibold fixed left-0 bg-[#FBDB17] rounded-lg ml-2 mt-2 px-4 py-1">
                                        Bids
                                        Complete</p> -->
                                    <img class="w-full " :src="bucket + photos" alt="">
                                </swiper-slide>
