                        ...
                        <div v-for="(aution, index) in data" :key="index"
                            ...
                            <div class="w-full flex   p-5 sm:p-0 relative" :class="changeLayouts ? 'flex-col' : ''">
                                <swiper pagination :modules="modules" :slides-per-view="1" class="swiper-autions"
                                    ...
                                    <swiper-slide v-for="(photos, indexPhoto) in aution.photos" :key="indexPhoto">
                                        <!--  <p class="font-semibold fixed left-0 bg-[#FBDB17] rounded-lg ml-2 mt-2 px-4 py-1">
                                        Bids
                                        Complete</p> -->
                                        <img class="w-full h-full object-cover" :src="bucket + photos" alt="">
                                    </swiper-slide>
                                ...
                                <div class="w-full flex justify-between gap-3 " :class="changeLayouts ? 'flex-col' : ''">
                                    <RouterLink
                                        :to="{ name: 'action-details-dealers', query: { data: JSON.stringify(aution) } }"
                                        ...
                                        <div class="flex gap-4" :class="changeLayouts ? 'flex-col' : ''">
                                            ...
                                            <div class="flex gap-4">
                                                ...
                                                <p>{{ aution.vehicleDetails.odometer }} Kilometers</p>
                                            </div>
                                        </div>
                                        <div class="flex gap-4" :class="changeLayouts ? 'flex-col' : ''">
                                            <div class="flex gap-4">
                                                ...
                                                <p>{{ aution.vehicleDetails.color }}</p>
                                            </div>
                                            <div class="flex gap-4">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    viewBox="0 0 16 16" fill="none">
                                                ...
                                                <p>{{ aution.vehicleDetails.driveTrain }}</p>
                                            </div>
                                        </div>
                                        <div class="flex gap-4 "
                                    ...
                                    <div :class="changeLayouts ? 'w-full' : 'w-[40%] flex flex-col'"
                                        ...
                                        <div class="flex  p-4 pt-1  justify-between "
                                            ...
                                            <div class="space-y-1 flex w-full  justify-between items-center">
                                        ...
                                        <div @click="statusModal.openModal({ active: true, data: aution })"
