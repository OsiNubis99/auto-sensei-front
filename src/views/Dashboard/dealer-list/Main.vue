            ...
            <div class="w-[20%]  ">
                ...
                <div class="relative w-full">
                    ...
                    <input v-model="search" type="text"
                        class="bg-gray-50  text-gray-900 text-sm outline-none rounded-lg focus:ring-none focus:border-none block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-base-black dark:focus:ring-blue-500 dark:focus:border-blue-500"
