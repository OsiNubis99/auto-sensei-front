                                        ...
                                        <tr>
                                            ...
                                            <th scope="col"
                                                ...
                                                <div class="flex items-center gap-1">
                                                    ...
                                                    <svg class="cursor-pointer " @click="orderStatus"
                                                        xmlns="http://www.w3.org/2000/svg" width="14" height="14"
                                                        viewBox="0 0 14 14" fill="none">
                                                        <path
                                                            d="M6.99996 4.66667H4.66721L4.66663 11.6667H3.49996V4.66667H1.16663L4.08329 1.75L6.99996 4.66667ZM12.8333 9.33333L9.91663 12.25L6.99996 9.33333H9.33329V2.33333H10.5V9.33333H12.8333Z"
                                            ...
                                            <th scope="col" class="flex h-full py-4 px-6 md:justify-center gap-4">
                                                <div
                                                    class="md:w-[50%] justify-end text-sm flex gap-4 font-medium text-gray-900 whitespace-nowrap  ">
                                                    <!-- <div
                                                        class="py-3 px-6 text-xs font-medium tracking-wider text-left text-[#000] capitalize ">
                                                        History
                                                    </div> -->
                                                ...
                                                <div
                                                    class="md:w-[50%]  justify-start text-sm flex gap-3 font-medium text-gray-900 whitespace-nowrap ">
                                                    <p
                                        ...
                                        <tr v-for="(user, index) in dataTableSearch" :key="user?.id"
                                            ...
                                            <td
                                                ...
                                                <div v-if="user.status == 'active'"
                                                    ...
                                                    <div class=" w-1 h-1 md:w-2 md:h-2 rounded-full bg-[#05A54B]"></div>
                                                ...
                                                <div v-else
                                                    ...
                                                    <div class=" w-1 h-1 md:w-2 md:h-2 rounded-full bg-[#FF333E]"></div>
                                            ...
                                            <div
                                                class="flex h-full py-1 px-2 md:py-4 md:px-6 justify-end md:justify-center gap-1 md:gap-4 ">
                                                <td
                                                    class="md:w-[50%] md:justify-end text-sm flex gap-1 md:gap-4 font-medium text-gray-900 whitespace-nowrap ">
                                                    <button
                                                    ...
                                                    <!-- <button
                                                        ...
                                                        <p class="text-[10px] md:text-[13px] ">Menu</p>

                                                    </button> -->
                                                </td>
                                                <td
                                                    class="md:w-[50%] justify-start text-sm flex gap-1 md:gap-3 font-medium text-gray-900 whitespace-nowrap ">
                                                    <button
                                                        v-if="user.status == 'inactive' || user.status == 'unaproved'"
                                                        @click="confirmDealer(user)"
                                                        class="flex gap-1 bg-primary items-center border py-1 px-3  md:p-2 rounded-md border-[#E0E0E0]">
                                                        <p class="text-[10px] md:text-[13px] ">Accept</p>

                                                    </button>
                                                    <button v-if="user.status == 'active'" @click="rejetDealer(user)"
                                                        class="flex gap-1 items-center border py-1 px-3  md:p-2 bg-error text-white rounded-md border-[#E0E0E0]">
                                                        <p class="text-[10px] md:text-[13px] ">Reject</p>
    ...
    setup() {
        ...
        const getUserDealer = async () => {
            ...
            try {
                ...
                let counterPage = Math.ceil(store.userDealers?.data.length / 10)
        ...
        const rejetDealer = async (user) => {
            /*  isLoading.value = true */
            try {
                let res = await store.inactivateUser(user._id)
                if (res.status) {
                    getUserDealer()
                    /*  isLoading.value = false */
                }
