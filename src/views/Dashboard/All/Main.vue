<template>
    <div class="flex w-full flex-col justify-center gap-6 items-center custom-header-all ">
    ...
    <div class="relative max-w-[100rem] mx-auto z-50 top-[60px] ">
        <div class="flex justify-between mt-5 gap-7">
            <div class="w-2/4  ">
                <div class="bg-white p-5 shadow-steps">
                    ...
                    <div class="flex pt-5 cursor-pointer justify-between">
                        <p class="font-medium">Draft <span class="text-[#858585]">4</span></p>
            ...
            <div class="w-[70%]">
                ...
                <div>
                    <div class="bg-white flex  mb-7 gap-5 items-start shadow-steps  w-full">
                        <div class="w-full flex  p-5 sm:p-0 relative">
                            <swiper pagination :modules="modules" :slides-per-view="1" class="w-[40%]">
                                <swiper-slide>
                                    <p class="font-semibold fixed left-0 bg-[#FBDB17] rounded-lg ml-2 mt-2 px-4 py-1">Bids
                                        Complete</p>
                                    <img class="w-full "
                            ...
                            <div class="w-full flex justify-between gap-3 ">
                                ...
                                <div class="flex p-5 flex-col pl-4 ga justify-between border-l-2 border-[#E0E0E0]">
                                    <div class=" space-y-2 ">
                                        <p>Final Bids</p>
                                        <p class=" font-medium text-base-black  ">$8000 <span
                                                class="text-[#666666] mt-2">/24
                                                Bids</span></p>
                                        <p>Approval period ends in <span class="text-[#FF9A02] font-medium">08 Hours
                                            </span>
                                        </p>
                                    </div>
                    ...
                    <div class="bg-white flex  mb-7 gap-5 items-start shadow-steps  w-full">
                        <div class="w-full flex  p-5 sm:p-0">
                            <swiper pagination :modules="modules" :slides-per-view="1" class="w-[40%]  ">
                                <swiper-slide>
                                    <img class="w-full "
                                        src="https://http2.mlstatic.com/D_NQ_NP_978610-MLV73175181347_112023-O.webp" alt="">
