<template>
    <div class="bg-white flex flex-col mb-7 gap-5 items-start shadow-steps p-5 w-full">
        ...
        <div class="flex max-w-xs flex-col gap-5">
            <div class="border flex flex-col gap-4 items-center border-[#E0E0E0] p-5">
                <div>
                    <img class="w-[250px] h-[150px]  object-cover " v-if="form?.previewDocument"
                        :src="form?.previewDocument" alt="">
                    <svg v-else class="w-[100px] h-[100px]" fill="#6d6d6d42" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 20 20">
                        <path
                ...
                <p v-else class="text-xs font-medium text-[#666]">Supported Files JPG, GIF or PNG. Max size of 1Mb</p>
            </div>
            <label
        ...
        <div class="flex max-w-xs flex-col gap-5">
            <div class="border flex flex-col gap-4 items-center border-[#E0E0E0] p-5">
                <div>
                    <img class="w-[250px] h-[150px]  object-cover " v-if="form?.preview" :src="form?.preview" alt="">
                    <svg v-else class="w-[100px] h-[100px]" fill="#6d6d6d42" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 20 20">
                        <path
                            d="M16.88 9.1A4 4 0 0 1 16 17H5a5 5 0 0 1-1-9.9V7a3 3 0 0 1 4.52-2.59A4.98 4.98 0 0 1 17 8c0 .38-.04.74-.12 1.1zM11 11h3l-4-4-4 4h3v3h2v-3z" />
                ...
                <div v-if="form?.img?.name" class="flex w-full items-start flex-col justify-start gap-1">
                    <p class="text-xs font-medium w-[200px] text-[#666] truncate"> <strong>Size:</strong> {{
                        form?.img?.mb }}Mb - </p>
                    <p class="text-xs font-medium w-[200px] text-[#666] truncate"><strong>Name:</strong>
                        {{ form?.img?.name }}</p>
        ...
        <div class="grid grid-cols-3 gap-5">
            <div class="flex max-w-xs flex-col gap-2">
                ...
                <div class="border flex flex-col gap-4 items-center border-[#E0E0E0] p-5">
                    <div>
                        <img class="w-full full  object-cover " v-if="form?.preview" :src="form?.preview" alt="">
                        <svg v-else class="w-[100px] h-[100px]" fill="#6d6d6d42" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 20 20">
                            <path
                                d="M16.88 9.1A4 4 0 0 1 16 17H5a5 5 0 0 1-1-9.9V7a3 3 0 0 1 4.52-2.59A4.98 4.98 0 0 1 17 8c0 .38-.04.74-.12 1.1zM11 11h3l-4-4-4 4h3v3h2v-3z" />
        ...
        const previewImage = (event, string) => {
            ...
            if (input.files) {
                if (filesize > maxfilesize) {
                    ...
                    form.value.previewDocument = null
