  ...
  <div :class="op.step1 ? 'md:h-screen' : 'h-fit'" class="bg-[#BDBDBF66] md:bg=[#F9F9F9]">
    <div>
      <div class="absolute hidden md:block w-full h-[200px] overflow-hidden bg-[#0B1107]">
        <svg class="w-full" xmlns="http://www.w3.org/2000/svg" width="1768" height="260" viewBox="0 0 1768 260" fill="none">
          <path
            opacity="0.2"
        ...
        <div class="flex justify-center flex-col lg:flex-row lg:mt-5 md:gap-7 relative">
          <div class="lg:w-2/4 w-full">
            <div class="w-full left-0 z-50 block lg:hidden">
              <div class="py-2 bg-white shadow-md">
                <div class="flex items-center cursor-pointer justify-between uppercase w-full text-sm px-4 py-2" @click="expanded = !expanded">
                  <span class="text-[#666666] text-center">Complete our 3 step process</span>
                  <svg
                    class="transition-all ease-linear mb-1 duration-200"
                    ...
                    fill="none"
                  >
                    <path d="M13.1717 12.0007L8.22168 7.05072L9.63568 5.63672L15.9997 12.0007L9.63568 18.3647L8.22168 16.9507L13.1717 12.0007Z" fill="#000" />
                  </svg>
                </div>
                <div class="grid text-sm text-slate-600 overflow-hidden transition-all duration-300 ease-in-out" :class="expanded ? 'grid-rows-[1fr] opacity-100' : 'grid-rows-[0fr] opacity-0'">
                  <div class="overflow-hidden">
                    <div class="p-5 pt-0">
                      <div class="flex justify-between gap-[100px] mt-7 items-center">
                        <div class="flex hr-custims-1 items-center gap-5">
                          <div v-if="op.step1 && !checkStep.step1" class="flex justify-center bg-[#1F94F0] items-center w-8 h-8 text-white rounded-full">1</div>
                          <div v-if="(checkStep.step1 && !op.step1) || (op.step1 && op.step2 && op.step3)" class="flex justify-center items-center w-8 h-8 text-white bg-[#000] rounded-full">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                              <path d="M9.22232 13.82L17.393 5.64844L18.6508 6.90533L9.22232 16.3338L3.56543 10.6769L4.82232 9.41999L9.22232 13.82Z" fill="white" />
                            </svg>
                          </div>
                          <p>General Information</p>
                        </div>
                        <svg class="absolute right-5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                          <path d="M13.1717 12.0007L8.22168 7.05072L9.63568 5.63672L15.9997 12.0007L9.63568 18.3647L8.22168 16.9507L13.1717 12.0007Z" fill="#858585" />
                        </svg>
                      </div>
                      <div class="flex justify-between gap-[100px] mt-7 items-center">
                        <div class="flex items-center hr-custims-2 gap-5">
                          <div v-if="!checkStep.step2" :class="op.step2 ? 'bg-[#1F94F0]' : 'bg-[#E0E0E0]'" class="flex justify-center items-center w-8 h-8 text-white rounded-full">2</div>
                          <div v-if="(checkStep.step2 && !op.step2) || (op.step1 && op.step2 && op.step3)" class="flex justify-center items-center w-8 h-8 text-white bg-[#000] rounded-full">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                              <path d="M9.22232 13.82L17.393 5.64844L18.6508 6.90533L9.22232 16.3338L3.56543 10.6769L4.82232 9.41999L9.22232 13.82Z" fill="white" />
                            </svg>
                          </div>
                          <p :class="op.step2 || checkStep.step2 ? 'text-[#000]' : 'text-[#E0E0E0]'">Vehicles Details</p>
                        </div>
                        <svg class="absolute right-5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                          <path d="M13.1717 12.0007L8.22168 7.05072L9.63568 5.63672L15.9997 12.0007L9.63568 18.3647L8.22168 16.9507L13.1717 12.0007Z" fill="#858585" />
                        </svg>
                      ...
                      <div class="flex justify-between gap-[100px] mt-7 items-center">
                        <div class="flex items-center gap-5">
                          <div v-if="!checkStep.step3" :class="op.step3 ? 'bg-[#1F94F0]' : 'bg-[#E0E0E0]'" class="flex justify-center items-center w-8 h-8 text-white rounded-full">3</div>
                          <div v-if="op.step1 && op.step2 && op.step3" class="flex justify-center items-center w-8 h-8 text-white bg-[#000] rounded-full">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                              <path d="M9.22232 13.82L17.393 5.64844L18.6508 6.90533L9.22232 16.3338L3.56543 10.6769L4.82232 9.41999L9.22232 13.82Z" fill="white" />
                            </svg>
                          </div>
                          <p :class="op.step3 || checkStep.step3 ? 'text-[#000]' : 'text-[#E0E0E0]'">Upload Photos</p>
                        </div>
                        <svg class="absolute right-5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                          <path d="M13.1717 12.0007L8.22168 7.05072L9.63568 5.63672L15.9997 12.0007L9.63568 18.3647L8.22168 16.9507L13.1717 12.0007Z" fill="#858585" />
                        </svg>
            ...
            <div class="bg-white hidden lg:block p-5 shadow-steps">
              ...
              <div class="flex justify-between gap-[100px] mt-7 items-center">
                <div class="flex hr-custim-1 items-center gap-5">
                  <div v-if="op.step1 && !checkStep.step1" class="flex justify-center bg-[#1F94F0] items-center w-10 h-10 text-white rounded-full">1</div>
                  <div v-if="(checkStep.step1 && !op.step1) || (op.step1 && op.step2 && op.step3)" class="flex justify-center items-center w-10 h-10 text-white bg-[#000] rounded-full">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                      <path d="M9.22232 13.82L17.393 5.64844L18.6508 6.90533L9.22232 16.3338L3.56543 10.6769L4.82232 9.41999L9.22232 13.82Z" fill="white" />
                    </svg>
                  </div>
              ...
              <div class="flex justify-between gap-[100px] mt-7 items-center">
                <div class="flex items-center hr-custim-2 gap-5">
                  <div v-if="!checkStep.step2" :class="op.step2 ? 'bg-[#1F94F0]' : 'bg-[#E0E0E0]'" class="flex justify-center items-center w-10 h-10 text-white rounded-full">2</div>
                  <div v-if="(checkStep.step2 && !op.step2) || (op.step1 && op.step2 && op.step3)" class="flex justify-center items-center w-10 h-10 text-white bg-[#000] rounded-full">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                      <path d="M9.22232 13.82L17.393 5.64844L18.6508 6.90533L9.22232 16.3338L3.56543 10.6769L4.82232 9.41999L9.22232 13.82Z" fill="white" />
                    </svg>
                  </div>
              ...
              <div class="flex justify-between gap-[100px] mt-7 items-center">
                <div class="flex items-center hr-custim-2 gap-5">
                  <div v-if="!checkStep.step3" :class="op.step3 ? 'bg-[#1F94F0]' : 'bg-[#E0E0E0]'" class="flex justify-center items-center w-10 h-10 text-white rounded-full">3</div>
                  <div v-if="op.step1 && op.step2 && op.step3" class="flex justify-center items-center w-10 h-10 text-white bg-[#000] rounded-full">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                      <path d="M9.22232 13.82L17.393 5.64844L18.6508 6.90533L9.22232 16.3338L3.56543 10.6769L4.82232 9.41999L9.22232 13.82Z" fill="white" />
                    </svg>
                  </div>
          ...
          <div class="w-full">
            <template v-if="loading || loadingUploadImages">
              <div v-if="loading" class="bg-white h-[calc(100vh_-_108px)] md:h-[50vh] flex flex-col md:mb-7 gap-5 items-start md:shadow-steps md:p-5 w-full">
                <div class="w-full h-full flex justify-center items-center">
                  <div class="text-indigo-700">
                    <div class="h-12 w-12 md:h-[80px] md:w-[80px]">
                      <div class="animate-bounce">
                        <svg xmlns="http://www.w3.org/2000/svg" class="animate-spin" fill="#c1f861" stroke="#fff" stroke-width="0" viewBox="0 0 16 16">
                          <path
                ...
                <template v-if="arrayUpload?.length > 0">
                  <div class="flex gap-6">
                    ...
                    <div class="flex flex-col">
                      <p class="text-[13px] font-Nohemi md:text-xl">
                        Uploading
                        <strong>{{ arrayUpload?.length }}</strong>
                        of
                        <strong>{{ formData.images.length }}</strong>
                      </p>
                      <p class="text-[10px] font-Nohemi md:text-base">This may take a few minutes.</p>
                    </div>
                  </div>
                  <div class="grid grid-cols-1 md:grid-cols-3 2xl:grid-cols-4 px-3 scroll-custom w-full m-auto py-6 gap-6 h-fit overflow-hidden">
                    <div class="flex w-full flex-col items-center" v-for="(image, index) in arrayUpload">
                      <div class="animate-fade-up w-full animate-ease-in-out" :class="`animate-delay-${index}00 animate-duration-${index + 1}000`">
                        <div class="relative w-full flex justify-end group transition-all ease-out duration-300">
                          <div class="relative w-full">
                            <p
                              :class="image?.format == 'video' ? 'bg-[#1f94f0] text-white ' : 'bg-primary text-base-black '"
                              class="absolute z-50 font-bold py-1 px-3 top-2 uppercase left-2 text-[8px] rounded-lg"
                            >
                              {{ image?.format }}
                            </p>
                            <video v-if="image?.format == 'video'" poster :src="image.preview" class="object-cover shadow-image-upload w-full h-[150px] rounded-lg mb-4"></video>
                            <img v-else class="object-cover shadow-image-upload w-full h-[150px] rounded-lg mb-4" :src="image.preview" />
                          </div>
                        </div>

                        <div class="flex gap-1 flex-col">
                          <p class="text-xs font-medium truncate w-[120px]">
                            Name:
                            {{ image.name }}
                          </p>
                          <p class="text-xs font-medium truncate">
                            Type:
                            <span class="uppercase bg-[#6d53b0] text-white shadow-lg font-semibold ml-2 px-2 py-1 text-[8px] rounded-md">
                              {{ image?.type }}
                            </span>
                          </p>
                        ...
                        <div v-if="!image.completed" class="w-full flex flex-col md:gap-2">
                          <div class="bg-[#E5E5E5] whitespace-pre shadow-sm w-full rounded-full h-4">
                            <div :style="{ width: porcertanje + '%' }" class="h-4 bg-primary flex justify-center items-center rounded-full shadow-progreess">
            ...
            <template v-else>
              <GeneralInformation
                v-if="op.step1"
                :key="componentKey"
                :nextGeneralInformation="nextGeneralInformation"
                :form="formData"
                :op="op"
                :checkStep="checkStep"
                :launch="launch"
                ...
                :onChangeGetProvince="onChangeGetProvince"
              ...
              <VehiclesDetails
                ...
                :key="componentKey"
                :saveData="saveData"
                :nextVehiclesDetails="nextVehiclesDetails"
                :form="formData"
                :op="op"
                :checkStep="checkStep"
                :launch="launch"
              ...
              <UploadPhotos
                v-if="op.step3"
                :key="componentKey"
                :nextUploadPhotos="nextUploadPhotos"
                :form="formData"
                :op="op"
                :checkStep="checkStep"
                :launch="launch"
  ...
  setup() {
    ...
    const nextGeneralInformation = async () => {
      ...
      if (Object.entries(invalid.value).length > 0) {
        toast(invalid?.value?.numberVinGenerals || invalid?.value?.date || invalid?.value?.province || invalid?.value?.city || invalid?.value?.keys || invalid?.value?.currently || 'Required field', {
          type: 'error',
        });
        return;
      }
      ...
      if (Object.entries(invalid.value).length === 0) {
        ...
        if (resFiles) {
          try {
            ...
            if (res) {
              let resDtaLate = await dataLayer.push({
                event: 'LaunchAuction',
                formType: res.data /* Or other relevant information 'userId': 'USER_ID' If you track user IDs and it's compliant with our privacy policy*/,
              });
