    ...
    <div class="mx-auto bg-[#F0F0F0] relative">
        ...
        <div class="relative  max-w-[100rem] mx-auto z-50 md:top-[60px] pb-10 ">
            ...
            dataDetails?.vehicleDetails?.doors
                                ...
                                <div class="flex gap-4 flex-col p-4 w-full">
                                    <div class="grid grid-cols-6 gap-6">
                                        <p class=" font-semibold col-span-2  md:text-base text-xs">Exterior Color</p>
                                        <p class="md:text-base text-xs whitespace-pre"
            ...
            dataDetails?.vehicleDetails?.odometer }}
                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        <p class=" font-semibold col-span-2  md:text-base text-xs">Tire Condition</p>
                                        <p class="md:text-base text-xs col-span-4 capitalize"
            ...
            dataDetails?.vehicleDetails?.tireCondition
                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        <p class=" font-semibold col-span-2  md:text-base text-xs">Brake Condition</p>
                                        <p class="md:text-base text-xs col-span-4 capitalize"
            ...
            dataDetails?.vehicleDetails?.brakeCondition
                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        <p class=" font-semibold col-span-2  md:text-base text-xs">Vehicle is Currently
                                        </p>
                                        <p class="md:text-base text-xs col-span-4 capitalize "
            ...
            dataDetails?.vehicleStatus?.status
                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        <p class=" font-semibold col-span-2  md:text-base text-xs">Bank/Institute</p>
