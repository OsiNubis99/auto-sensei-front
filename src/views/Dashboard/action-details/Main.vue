<template>
    <div class=" bg-[#F0F0F0] h-full z-[100] relative">
        <div class="max-w-[90%] pt-20 mx-auto ">
            <div v-if="loading"
            ...
            <div class="relative  max-w-[120rem] mx-auto z-50 pb-10 ">
                <div v-if="route.meta.adminAuth" class=" hidden md:flex gap-2 items-center">
                    <div class="flex items-center gap-2">
                        <p v-if="router.options.history.state.back == '/action-list'" class="text-[#858585]">Auctions
                            List
                        </p>
                        ...
                        <swiper @swiper="setThumbsSwiper" :spaceBetween="10" :slidesPerView="6" :freeMode="true"
                            ...
                            <swiper-slide v-if="dataDetails?.photos?.length > 0"
                                ...
                                <div v-if="index == 5" class="relative flex justify-center items-center cursor-pointer">
                                    ...
                                    <p class="text-white absolute md:text-base text-[8px]  whitespace-pre z-50 "> All
                                        Photos
                    ...
                    <div class="flex flex-col lg:flex-row lg:gap-4 ">
                        <div class=" p-4  lg:w-[65%] md:p-0  ">
                            <div class="bg-white border md:p-4  border-[#E0E0E0]">
                                <div class="flex p-2 items-center  gap-3 ">
                                    ...
                                    <p class="md:text-base pt-1 font-bold text-sm">Vehicle Information</p>
                                </div>

                                <div
                                    class="border-t-[1px] py-2  flex  flex-col md:flex-row justify-between items-start  border-[#E0E0E0]">
                                    <div class="flex gap-4 flex-col p-4 w-full border-r-[1px] border-[#E0E0E0] ">
                                        <div class="grid grid-cols-6 gap-6 capitalize ">
                                            <p class=" md:text-base text-xs font-semibold col-span-2">VIN</p>
                                        ...
                                        <div class="grid grid-cols-6 gap-6 capitalize ">
                                            ...
                                            <p class="md:text-base text-xs whitespace-pre"
                                                v-if="dataDetails?.vehicleDetails?.make">{{
                                                    dataDetails?.vehicleDetails?.make }}
                                            </p>
                                            <p v-else
                                                class="col-span-4 capitalize text-xs md:text-base text-[#A3A3A3] ">The
                                                seller didn't provide
                                        ...
                                        <div class="grid grid-cols-6 gap-6 capitalize ">
                                            ...
                                            <p class="md:text-base text-xs whitespace-pre"
                                                v-if="dataDetails?.vehicleDetails?.model">{{
                                                    dataDetails?.vehicleDetails?.model
                                                }}</p>
                                            <p v-else
                                                class="col-span-4 capitalize text-xs md:text-base text-[#A3A3A3] ">The
                                                seller didn't provide
                                        ...
                                        <div class="grid grid-cols-6 gap-6 capitalize ">
                                            <p class=" md:text-base text-xs font-semibold col-span-2">Body Type</p>
                                            <p class="md:text-base text-xs whitespace-pre"
                                                v-if="dataDetails?.vehicleDetails?.bodyType">{{
                                        ...
                                        <div class="grid grid-cols-6 gap-6 capitalize ">
                                            <p class=" md:text-base text-xs font-semibold col-span-2">Cylinder</p>
                                            <p class="md:text-base text-xs whitespace-pre"
                                                v-if="dataDetails?.vehicleDetails?.cylinder">{{
                                        ...
                                        <div class="grid grid-cols-6 gap-6 capitalize ">
                                            <p class=" md:text-base text-xs font-semibold col-span-2">Transmission</p>
                                            <p class="md:text-base text-xs whitespace-pre"
                                                v-if="dataDetails?.vehicleDetails?.transmission">{{
                                        ...
                                        <div class="grid grid-cols-6 gap-6 capitalize ">
                                            <p class=" md:text-base text-xs font-semibold col-span-2">Drive Train</p>
                                            <p class="md:text-base text-xs whitespace-pre"
                                                v-if="dataDetails?.vehicleDetails?.driveTrain">
                                                {{
                                        ...
                                        <div class="grid grid-cols-6 gap-6 capitalize ">
                                            <p class=" md:text-base text-xs font-semibold col-span-2">Doors</p>
                                            <p class="md:text-base text-xs whitespace-pre"
                                                v-if="dataDetails?.vehicleDetails?.doors">{{
                                                    dataDetails?.vehicleDetails?.doors
                                                }}</p>
                                            <p v-else
                                                class="col-span-4 capitalize text-xs md:text-base text-[#A3A3A3] ">The
                                                seller didn't provide
                                    ...
                                    <div class="flex gap-4 flex-col p-4 w-full">
                                        <div class="grid grid-cols-6 gap-6">
                                            <p class=" font-semibold col-span-2  md:text-base text-xs">Exterior Color
                                            </p>
                                            <p class="md:text-base text-xs whitespace-pre"
                                                v-if="dataDetails?.vehicleDetails?.color">{{
                                        ...
                                        <div class="grid grid-cols-6 gap-6">
                                            <p class=" font-semibold col-span-2  md:text-base text-xs">Odometer</p>
                                            <p class="md:text-base text-xs col-span-4 capitalize"
                                                v-if="dataDetails?.vehicleDetails?.odometer">{{
                                        ...
                                        <div class="grid grid-cols-6 gap-6">
                                            <p class=" font-semibold col-span-2  md:text-base text-xs">Tire Condition
                                            </p>
                                            <p class="md:text-base text-xs col-span-4 capitalize"
                                                v-if="dataDetails?.vehicleDetails?.tireCondition">
                                                {{
                                        ...
                                        <div class="grid grid-cols-6 gap-6">
                                            <p class=" font-semibold col-span-2  md:text-base text-xs">Brake Condition
                                            </p>
                                            <p class="md:text-base text-xs col-span-4 capitalize"
                                                v-if="dataDetails?.vehicleDetails?.brakeCondition">{{
                                        ...
                                        <div class="grid grid-cols-6 gap-6">
                                            <p class=" font-semibold col-span-2  md:text-base text-xs">Vehicle is
                                                Currently
                                            </p>
                                            <p class="md:text-base text-xs col-span-4 capitalize "
                                                v-if="dataDetails?.vehicleStatus?.status">{{
                                        ...
                                        <div class="grid grid-cols-6 gap-6">
                                            <p class=" font-semibold col-span-2  md:text-base text-xs">Bank/Institute
                                            </p>
                                            <p class="md:text-base text-xs col-span-4"
                                                v-if="dataDetails?.vehicleStatus?.financingCompany">{{
                                        ...
                                        <p class="md:text-base text-xs whitespace-pre"
                                            v-if="dataDetails?.vehicleStatus?.remainingPayments">
                                        ...
                                        <div class="grid grid-cols-6 gap-6">
                                            <p class=" font-semibold col-span-2  md:text-base text-xs">Vehicle Reports
                                            </p>
                                            <div class="flex w-full items-center gap-2 col-span-3 justify-between">
                                                ...
                                                <p
                                                    class="text-[#7EC600] whitespace-pre text-xs md:text-lg font-medium ">
                                                    View History</p>
                                    ...
                                    <div v-if="dataDetails?.buyNew?.anyVehicle"
                                        ...
                                        <div class="flex gap-4 flex-col p-4 w-full border-r-[1px] border-[#E0E0E0] ">
                                            <div class="grid grid-cols-6 gap-6 capitalize ">
                                                ...
                                                <p v-else
                                                    class="col-span-4 capitalize text-xs md:text-base text-[#A3A3A3] ">
                                                    The
                                                    seller didn't provide
                                                    information
                                                </p>
                                            ...
                                            <div class="grid grid-cols-6 gap-6 capitalize ">
                                                <p class=" md:text-base text-xs font-semibold col-span-2">Mileage From
                                                </p>
                                                <p class="md:text-base text-xs whitespace-pre"
                            ...
                            <div class="bg-white border p-4 mt-6 space-y-3 border-[#E0E0E0]">
                                <div class="flex border-b-2 gap-2 pb-2 border-[#E0E0E0] md:gap-4">
                                    <svg class=" w-5 h-5 md:h-6 md:w-6 mt-4" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div class="md:p-2 mt-4 mx-4 lg:w-[35%] border border-[#E0E0E0] bg-white h-fit ">
                            <div class="flex gap-3 p-2 items-center ">
                                <svg xmlns="http://www.w3.org/2000/svg" class=" w-5 h-5 md:h-6 md:w-6"
                                ...
                                <p class="md:text-base font-bold text-sm">Bid Information</p>
                            </div>
                            <div v-if="dataDetails?.status == 'upcoming'"
                                ...
                                <div class="flex flex-col md:gap-2 md:mt-4">
                            ...
                            <div v-if="dataDetails?.status == 'live'"
                                    ...
                                    <div class="flex flex-col  w-full">
                                        <div class="flex flex-col gap-2 bg-[#F7F7F7] p-2 md:p-4 rounded-lg ">
                                            ...
                                            <div class="flex gap-2">
                                                ...
                                                <template v-else>
                                                    <p class="py-1 px-2 border text-sm border-[#C2C2C2] rounded-full ">
                                                        You
                                                        haven’t
                                                        bid yet</p>
                                                </template>
                                ...
                                <div class="flex flex-col gap-2 mt-4">
                                    ...
                                    <div class="flex items-center gap-2 mt-3">
                                        ...
                                        <p class=" text-xs md:text-base">All bids are binding and all sales are final
                                        </p>
                                    </div>
                                        ...
                                        <div class="flex flex-col gap-2 bg-[#F7F7F7] p-2 md:p-4 rounded-lg ">
                                            ...
                                            <div class="flex gap-2">
                                                <p class=" text-md md:text-xl font-medium">{{
                                                    moment(dataDetails.vehicleDetails.dropOffDate)
                                                        .format('MMMMDD, YYYY') }} </p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <template v-else>
                        <div v-if="steps.step1" class="w-full p-5 flex flex-col justify-center items-center">
                            <div class="flex justify-center items-center flex-col gap-3">
                                ...
                                <p class=" text-center text-lg p-5 font-medium ">Thank you for completing the process!
                                    Enjoy
