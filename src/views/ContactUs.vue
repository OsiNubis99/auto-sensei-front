...
<template>
    <div class="mt-40 flex justify-center  items-center gap-10 flex-col">
        ...
        <div class="flex justify-center items-center flex-col mt-q7">
        ...
        <div class="flex gap-10 pt-20 pb-10 max-w-6xl ">
            <div class="w-full">
                <img class="h-full w-full object-cover" src="../assets/img/png/mapa.png" alt="">
            </div>
            <div class="flex gap-4 flex-col w-full">
                <div>
                    <p class="text-2xl font-semibold">Send email to us</p>
                    <p>Description</p>
                </div>
