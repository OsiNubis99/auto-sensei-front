<template>
    <div v-show="statusModal.isActive"
        ...
        <div class="max-w-xl overflow-auto  bg-white rounded-lg shadow-xl">
            <div class="p-4 rounded-t-lg  bg-base-black flex items-center justify-between">
                <p class="text-xl text-white">Auto Bid</p>
            ...
            <div v-if="steps.step1 || (steps.step2 && state == 'edit')">
                <div class="flex gap-3 items-start border-b border-[#E0E0E0] p-5">
                    ...
                    <div class="h-[130px] flex justify-between flex-col">
                        ...
                        <div>
                            <p>Current Bid</p>
                            <p class="font-semibold">{{ statusModal.data?.bids[0]?.biddingLimit }}</p>
                        </div>
                    </div>
                </div>
                <template v-if="steps.step1">
                    <div class="m-5 p-4 border rounded-lg border-[#E0E0E0]">
                        <p class="font-semibold">Bid Information</p>
                        <div class="flex gap-3 mt-4 flex-col">
                            ...
                            <div class="flex gap-2 items-center justify-between">
                                ...
                                <p class="font-medium">John Cenna</p>
                            </div>
                            <div class="flex gap-2 items-center justify-between">
                                <div class="flex gap-2 items-center">
            ...
            <div v-if="steps.step2">
                <template v-if="state == 'edit'">
                    <div class="p-5">
                        ...
                        <button @click="updateAmounBit" :class="sizeObjet == 0 ? 'bg-primary' : 'bg-base-gray text-white'"
                ...
                <template v-if="state == 'cancel'">
                    <div class="p-5 flex flex-col items-center gap-4">
                        ...
                        <p class="text-center">Give your best bid amount reducing the time spent watching the bid with our
                            auto
                            bid feature. Are you
                            sure want to cancel?</p>
                    </div>
                    <div class="flex w-full gap-4 p-5 pt-0 items-center">
                        <button @click="editAutobid(2, 'cancel')" class="btn w-full bg-primary text-blue-dark ">Keep Auto
                            Bid</button>
