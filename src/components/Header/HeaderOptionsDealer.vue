<template>
    <nav class="bg-[#22282F] flex flex-nowrap overflow-auto scroll-custom-options items-center gap-6 py-4 px-3 md:p-5 ">
        <RouterLink :to="useAuth.userData.type == 1 ? '/upcoming-sellers' : '/upcoming'"
            :class="path == 'upcoming' || path == 'upcoming-sellers' ? 'bg-primary' : 'bg-[#464B50] text-white'"
        ...
        <RouterLink :to="useAuth.userData.type == 1 ? '/liveSeller' : '/liveDealer'"
            :class="path == 'liveDealer' || path == 'liveSeller' ? 'bg-primary' : 'bg-[#464B50] text-white'"
            class="flex gap-3 md:h-5 rounded-[8px]  h-8 items-center p-2 md:p-5  w-auto  ease-linear duration-500 ">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                <path
                    ...
                    :fill="path == 'liveDealer' || path == 'liveSeller' ? '#09121F' : '#C2C2C2'" />
            </svg>
        ...
        <RouterLink :to="useAuth.userData.type == 1 ? '/current-bits-seller' : '/current-bits'"
            :class="path == 'current-bits' || path == 'current-bits-seller' ? 'bg-primary' : 'bg-[#464B50] text-white'"
            class="flex gap-3 md:h-5 rounded-[8px]  h-8 items-center p-2 md:p-5  w-auto  ease-linear duration-500 ">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                <path
                    ...
                    :fill="path == 'current-bits' || path == 'current-bits-seller' ? '#09121F' : '#C2C2C2'" />
            </svg>
        ...
        <RouterLink :to="useAuth.userData.type == 1 ? '/completed-seller' : '/completed-buyer'"
            :class="path == 'completed-buyer' || path == 'completed-seller' ? 'bg-primary' : 'bg-[#464B50] text-white'"
            class="flex gap-3 md:h-5 rounded-[8px]  h-8 items-center p-2 md:p-5  w-auto  ease-linear duration-500 ">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                <path
                    ...
                    :fill="path == 'completed-buyer' || path == 'completed-seller' ? '#09121F' : '#C2C2C2'" />
            </svg>
