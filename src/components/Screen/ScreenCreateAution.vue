<template>
    <div class="flex w-full flex-col justify-center gap-6 items-center custom-header-all ">
        <div class="flex flex-col md:flex-row md:gap-20 items-end ">
            <div class="flex gap-8 flex-col p-5">
                <div class=" justify-center  flex md:w-full md:justify-start">
                    <img class=" w-40 h-40 md:w-full md:h-[30vh] object-cover md:object-contain"
                        src="@/assets/svg/vehiculoAll.svg" alt="">
                </div>
                <div>
                    <h1 class=" text-xl md:text-5xl text-center md:text-left font-semibold text-blue-dark ">
                        Get the best value <br>
                        for your car with <br> AutoSensei !
                    </h1>
                    <p class=" text-xs text-center md:text-base">Let the bids begin, post your auction, sell your car
                        quick as 48 hours.</p>
                </div>
            ...
            <div class="p-5">
                ...
                <div class="flex flex-col gap-8 pt-6">
                    <div class="flex items-center gap-3">
                        ...
                        <p class=" text-xs md:text-base ">Sell your car without any cost or fees</p>
                    </div>
                    <div class="flex items-center gap-3">
                        <div class="border p-1 rounded-full flex justify-center items-center border-[#05A54B]">
                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="15" viewBox="0 0 14 15" fill="none">
                        ...
                        <p class=" text-xs md:text-base ">Skip the hassle of visiting multiple dealers</p>
                    </div>
                    <div class="flex items-center gap-3">
                        <div class="border p-1 rounded-full flex justify-center items-center border-[#05A54B]">
                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="15" viewBox="0 0 14 15" fill="none">
                        ...
                        <p class=" text-xs md:text-base ">Sell from your home within just 48 hours</p>
                    </div>
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <p class=" text-xs md:text-base ">No more haggling with disinterested buyers</p>
                    </div>
                </div>
            </div>
        </div>
