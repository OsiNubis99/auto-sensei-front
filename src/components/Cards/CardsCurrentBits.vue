    ...
    <div class="w-full flex  sm:p-0 relative" :class="changeLayouts ? 'flex-col' : 'flex-col md:flex-row'">
        ...
        aution?.vehicleDetails?.make }} {{ aution?.vehicleDetails?.model }}</div>
                ...
                <div class="hidden md:grid 2xl:grid-cols-2 gap-1" :class="changeLayouts ? 'flex-col' : ''">
                    <div v-if="aution?.vehicleDetails?.vin" class="flex gap-2 items-center w-full">
                    ...
                    <div v-if="aution?.vehicleDetails?.odometer" class="flex gap-2 items-center w-full">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                            <path
                ...
                <div class="hidden md:grid 2xl:grid-cols-2 gap-1" :class="changeLayouts ? 'flex-col' : ''">
                    <div v-if="aution?.vehicleDetails?.color" class="flex gap-2 items-center w-full">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                            <path
                    ...
                    <div v-if="aution?.vehicleDetails?.driveTrain" class="flex gap-2 items-center w-full">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                            <path
